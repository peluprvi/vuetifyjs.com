export default {
  ...
  newStoreAlert: 'The new Vuetify store is now **live**!. Help support the project and get some cool swag at the same time! <a href="https://next.vuetifyjs.com/store" class="v-btn v-btn--white primary--text"><span class="v-btn__content">Check it out</span></a>',
