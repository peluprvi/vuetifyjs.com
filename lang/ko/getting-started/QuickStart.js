export default {
  ...
  newStoreAlert: '새로운 Vuetify 상점이 지금 **운영중**입니다.!. 이 프로젝트를 지원하면서 동시에 멋진 swag도 받으세요! <a href="https://vuetifyjs.com/store" class="v-btn v-btn--white primary--text"><span class="v-btn__content">지금 확인하세요</span></a>',
