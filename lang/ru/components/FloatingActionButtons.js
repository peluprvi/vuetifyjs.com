export default {
  ...
  examples: [{
    promotedAction: {
      ...
      desc: 'Плавающие кнопки действий можно прикрепить к блоку, чтобы обозначить повышеное действие в приложении. Размер будет использоваться в большинстве случае по умолчанию в, в то время как вариант `small` может использоваться для поддержания схожести с аналогичными элементами.'
    },
    small: {
