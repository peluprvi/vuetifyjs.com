...
let renderer
let readyPromise
const templatePath = resolve('./src/assets/index.template.html')
if (isProd) {
...
app.use('/static/manifest.json', serve('./src/static/manifest.json', true))
app.use('/static', serve('./src/static', true))
app.use('/public', serve('./src/public', true))
app.use('/static/robots.txt', serve('./src/static/robots.txt'))
