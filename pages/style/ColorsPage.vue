<template lang="pug">
  ...
  page(
    ...
    page-introduction(
      title="Style.Colors.header"
      desc="Style.Colors.headerText"
    )
    ...
    section#color-pack
      ...
      section-subheading(value="Style.Colors.colorPackSubHeader1")
      section-text(value="Style.Colors.colorPackSubText1")

      section-subheading(value="Style.Colors.colorPackSubHeader2")
